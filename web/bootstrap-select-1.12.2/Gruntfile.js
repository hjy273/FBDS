module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    clean: {
      css: 'angular-dist/css',
      js: 'angular-dist/js',
      docs: 'docs/docs/angular-dist'
    },
    ...
    concat: {
      ...
      main: {
        src: '<%= jshint.main.src %>',
        dest: 'angular-dist/js/<%= pkg.name %>.js'
      },
      i18n: {
        expand: true,
        src: '<%= jshint.i18n.src %>',
    ...
    umd: {
      ...
      i18n: {
        ...
        src: 'angular-dist/<%= jshint.i18n.src %>',
        dest: '.'
      }
    },
    ...
    uglify: {
      ...
      main: {
        src: '<%= concat.main.dest %>',
        dest: 'angular-dist/js/<%= pkg.name %>.min.js',
        options: {
          sourceMap: true,
          sourceMapName: 'angular-dist/js/<%= pkg.name %>.js.map'
        }
      },
      i18n: {
        expand: true,
    ...
    less: {
      ...
      css: {
        ...
        dest: 'angular-dist/css/<%= pkg.name %>.css'
      }
    },
    ...
    cssmin: {
      ...
      css: {
        src: '<%= less.css.dest %>',
        dest: 'angular-dist/css/<%= pkg.name %>.min.css'
      }
    },
